...
![](images/slack/channel-purpose.png)
...
![](images/slack/thread.png)

### Code and attachments

You can upload attachments to a channel. You can also post code. Mark small bits of code with backticks, like ``` `library(tidyverse)` ```. Code chuncks start and end with three backticks.
